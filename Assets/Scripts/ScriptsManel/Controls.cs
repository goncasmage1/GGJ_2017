...
public class Controls : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            restrictMoveX = transform.position.x + state.ThumbSticks.Left.X * speed;
        }
        ...
        transform.position = new Vector3(restrictMoveX, transform.position.y + state.ThumbSticks.Left.Y * speed + Mathf.Cos(Time.time*10) * 0.25f);
